 ...
 * majority = 사이즈 / 2를구한다.
 * nums를 순회하며 majority보다 중첩이 크면 해당 숫자 리턴한다.
 * ㄴ O(N2). 10m
 * =========================================
 * 정렬하고 중간값 리턴하면 빠를듯?
 * =========================================
 * O(N)처리를 위해서는 majorityElementBest 처럼 처리해야한다.
 */
